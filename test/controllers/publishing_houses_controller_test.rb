...
class PublishingHousesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create publishing_house" do
    assert_difference('PublishingHouse.count') do
      post publishing_houses_url, params: { publishing_house: { discount: @publishing_house.discount } }, as: :json
    end
  ...
  test "should update publishing_house" do
    patch publishing_house_url(@publishing_house), params: { publishing_house: { discount: @publishing_house.discount } }, as: :json
    assert_response 200
  end
